...
<html lang="en">
    <head>
        ...
        <title>User Profile Details | Registration and Login System</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">User Profile Details</h1>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                  ...
                                  <th>Action</th>
                                    ...
                                    <tbody>
                                              <?php $ret=mysqli_query($con,"select profile_id,designation,description,DOB,location from profile");
                              $cnt=1;
